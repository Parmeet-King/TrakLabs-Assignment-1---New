...
void menu()
{
    ...
    string str[13] = { "Enter \' 1\': ADD EMPLOYEE", "Enter \' 2\': EDIT EMPLOYEE", "Enter \' 3\': DELETE EMPLOYEE", "Enter \' 4\': DISPLAY EMPLOYEES", "Enter \' 5\': SEARCH EMPLOYEE",
                       ...
                       "Enter \'10\': DISPLAY DEPARTMENT", "Enter \'11\': SEARCH DEPARTMENT", "Enter \'12\': SORT DEPARTMENT", "Enter \' 0\': EXIT PROGRAM" };
    earr[0].id = -1;
    darr[0].id = -1;
